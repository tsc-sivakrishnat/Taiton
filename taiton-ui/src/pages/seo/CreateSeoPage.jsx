...
export function CreateSeoPage() {
  ...
  useEffect(() => {
    if (token && editId) {
      enterpriseApi.contentDetail(token, 'seo_page', editId)
        .then((res) => {
    ...
    <div className="cp-stack">
      ...
      <div className="cp-page-head">
        <div>
          ...
          <p className="cp-muted">Configure SEO page targets, keywords, schema types and metadata.</p>
        </div>
      </div>
      ...
      <section className="cp-card cp-card-pad">
        <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div className="cp-grid cp-grid-2" style={{ gap: '16px 20px' }}>
            ...
            <label className="cp-field">
              ...
              >
                ...
                <option value="/app/careers">Careers</option>
                ...
                <option value="/app/org/approvals">Approvals</option>
                <option value="/app/settings">Settings</option>
          ...
          {/* Section 3: Social & Open Graph metadata */}
          <h3 className="cp-section-title cp-section-title--in-card" style={{ fontSize: '16px', margin: '0' }}>Social & Open Graph (OG) Preview Graphics</h3>
          <div className="cp-grid cp-grid-2" style={{ gap: '16px 20px' }}>
            <label className="cp-field">
              <span className="cp-field-label-text">Social OG Title</span>
              <input
                type="text"
                className="cp-input"
                value={ogTitle}
            ...
            <label className="cp-field">
              <span className="cp-field-label-text">Social OG Description</span>
              <input
                type="text"
                className="cp-input"
                value={ogDescription}
            ...
            <label className="cp-field">
              ...
              <input
                ...
                placeholder="Descriptive text for social image graphics"
              />
            </label>

            <div className="cp-field">
              <span className="cp-field-label-text">Social OG Image Upload</span>
